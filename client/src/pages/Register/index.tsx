            ...
            <div className='w-full h-screen flex items-center justify-center m-auto flex-col'>
                <form className='shadow-shadow-ligth flex flex-col p-4 rounded w-96' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        <button className='bg-primary-button text-white rounded shadow-shadow-ligth px-2 py-1' type='button' onClick={() => reset()}>Clear</button>
                        <button className='bg-black text-white rounded shadow-shadow-ligth px-2 py-1' type="submit">Submit</button>
                    </div>
                </form>
                <div className='my-4'>
